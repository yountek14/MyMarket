...
|---|--------------|--------|-------------|
| 1 | ms-productos | 8082 | Gestiona el catálogo de productos, incluyendo nombre, categoría, unidad de medida, precio base, descripción y fecha de caducidad. |
...
| 5 | ms-proveedor | 8086 | Gestiona proveedores, información de contacto y datos asociados al abastecimiento. |
| 6 | ms-usuarios | 8087 | Gestiona usuarios del sistema, roles y datos de acceso. |
| 7 | ms-empleados | 8088 | Administra información del personal, cargos y datos asociados a trabajadores. |
| 8 | ms-pedidos | 8089 | Gestiona órdenes o solicitudes de productos a proveedores. |
| 9 | ms-precios | 8090 | Administra precios, variaciones, descuentos e historial de precios. |
| 10 | ms-reportes | 8091 | Consolida información de ventas, inventario, productos y proveedores para generar reportes. |
