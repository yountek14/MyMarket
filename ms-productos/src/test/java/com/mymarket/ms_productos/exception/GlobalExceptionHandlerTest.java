package com.mymarket.ms_productos.exception;
...
class GlobalExceptionHandlerTest {
    ...
    void handleNotFound_debeRetornar404() {
        ...
        EntityNotFoundException ex = new EntityNotFoundException("Producto no encontrado");
        ...
        assertEquals("/api/productos/99", response.getBody().getPath());
    }
    ...
    void handleValidation_debeRetornar400ConErroresDeCampo() {
        ...
        FieldError fieldError = new FieldError("producto", "nombre", "no puede estar vacio");
